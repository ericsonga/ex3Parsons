...
.. timed:: get_min_order_timed
   ...
   .. parsonsprob:: Get_Min_Order
      ...
      =====
      def getMinimum(numList) #distractor
      =====
          minimum = numList[0]
      =====
          minimum = 0 #distractor
      =====
          for index in range(len(numList)):
      =====
          for index in range(numList): #distractor
      =====
              current = numList[index]
      =====
              current = index #distractor
      =====
              if current < minimum:
      =====
              if current > minimum: #distractor
      =====
                  minimum = current
      =====
                  current = minimum #distractor
      =====
          return minimum
